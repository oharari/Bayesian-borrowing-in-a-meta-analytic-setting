...
#*******************************************************************************
#* The simulation from Example 3.2
#*******************************************************************************
...
#*******************************************************************************
RR_vec = seq(.675, .85, length = 200) # we let the relative risk vary
...
#*******************************************************************************
#* store the results in a data frame and calculate the minimum borrowing 
